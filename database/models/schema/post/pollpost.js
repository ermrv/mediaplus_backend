...
PollPostSchema.set('toObject', {
    virtuals: true
})
PollPostSchema.set('toJSON', {
    virtuals: true
})

PollPostSchema.virtual('responseCount').get(function () {
    const responseCount = []
...
PollPostSchema.statics.createPollPost = async function (description, mentions, opOne, opTwo, opThree, opFour, opFive, endsOn, userId) {
    try {
        postData = {
            opOne: opOne,
            opTwo: opTwo,
...
PollPostSchema.statics.pollReact = async function (pollPostId, optionChoice, userId) {
    try {
...
PollPostSchema.statics.pollReactRemove = async function (pollPostId, userId) {
    try {
        checkResponse = await this.findOne({
            _id: pollPostId,
            totalResponse: {
...
PollPostSchema.statics.pollUpdate = async function (pollPostId, description,  opOne, opTwo, opThree, opFour, opFive, endsOn, userId) {
    try {
        postData = {
            opOne: opOne,
            opTwo: opTwo,
...
PollPostSchema.plugin(mongoosastic, {
    'host': "localhost",
    'port': 9200
})


var Poll = mongoose.model('PollPost', PollPostSchema)
