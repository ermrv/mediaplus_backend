...
exports.addNewPost = async (req, res) => {
  try {
    ...
    if (req.files.length > 0 && req.files.length < 16) {
      ...
      var response = await db.post.createNewPost(postContentType, primary, sharedDescription, mentions, imagePost._id, req.userData.userId, postLocation, imagePost.hashtags)
