...
// Controller import
const index_controller = require('../src/controller');
const user_controller = require('../src/user/controller');
const status_controller = require('../src/status/controller');
const highlights_controller = require('../src/highlights/controller');
const message_controller = require('../src/message/controller');
const reaction_controller = require('../src/reaction/controller');
const comment_controller = require('../src/comment/controller');
const photo_controller = require('../src/photo/controller');
const promotion_controller = require('../src/promotion/controller');
const notification_controller = require('../src/notification/controller')
const delete_controller = require('../src/delete/controller')

//post controllers
const post_controller = require('../src/post/controller');
const textPost_controller = require('../src/post/textpost/controller');
const imagePost_controller = require('../src/post/imagepost/controller');
const videoPost_controller = require('../src/post/videopost/controller');
// const contest_controller = require('../src/post/contest/controller');
const poll_controller = require('../src/post/poll/controller');
// const event_controller = require('../src/post/event/controller');



const upload = require('../middleware/uploader/upload');
