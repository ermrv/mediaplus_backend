...
// Controller import
const index_controller = require('../controllers/controller');
const user_controller = require('../controllers/user/controller');
const status_controller = require('../controllers/status/controller');
const highlights_controller = require('../controllers/highlights/controller');
const message_controller = require('../controllers/message/controller');
const reaction_controller = require('../controllers/reaction/controller');
...
const promotion_controller = require('../controllers/promotion/controller');
...
const textPost_controller = require('../controllers/post/textpost/controller');
const imagePost_controller = require('../controllers/post/imagepost/controller');
const videoPost_controller = require('../controllers/post/videopost/controller');
// const contest_controller = require('../src/post/contest/controller');
const poll_controller = require('../controllers/post/poll/controller');
